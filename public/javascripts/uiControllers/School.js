            ...
            datas.forEach(function(data){
                ...
                str += '<tr>';
                    if(data.school_image){
                        var img = '/images/schools/thumb/'+data.school_image;
                    }else{
                        var img = '/images/dummy_user.gif';
                    }
                    str += '<td><img src="'+img+'" style="width:125px;height:125px;" alt="'+data.school_name+'" style="cursor:pointer;" /></td>';
                    str += '<td align="center"><a href="#" style="text-decoration:none;">'+data.school_name+'</a></td>';
                    str += '<td align="center">'+data.location+'</td>';
                    str += '<td align="center">'+data.operator+'</td>';
                    str += '<td align="center">'+tDate+'/'+tMonth+'/'+tYear+'</td>';
                    str += '<td align="center"><a href="/schools/operator/edit?id='+data.id+'">Edit</a></td>';
                str += '</tr>';
...
function loadMySchools(){
    $.getJSON("/schools/loadMySchools/", function(datas){
        if(datas){
            var str = '<table cellpadding="0" cellspacing="0" border="0" class="display" id="datatable" width="100%">'; 
            str += '<thead>';
            str += '<tr>';
