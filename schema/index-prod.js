...
var sequelize = new Sequelize('artmojo_node', 'art_node', 'jN8UtwVA', {
  // custom host; default: localhost
  host: 'productionserver.cb0qjomhckix.us-east-1.rds.amazonaws.com',
...
(function(m) {
    ...
    m.Artist.belongsTo(m.State);
    m.Artist.belongsTo(m.Country);
    ...
    m.Country.hasMany(m.Artist);
    m.Country.hasMany(m.School);
    ...
    m.Region.hasMany(m.Event);
    
    m.School.belongsTo(m.Region);
    m.School.belongsTo(m.City);
    m.School.belongsTo(m.State);
    m.School.belongsTo(m.Country);
    ...
    m.State.hasMany(m.Artist);
    m.State.hasMany(m.School);
    m.State.hasMany(m.City);
    m.State.hasMany(m.Event);
